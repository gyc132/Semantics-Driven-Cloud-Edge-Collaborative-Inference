...
with open('/Users/beibei/PycharmProjects/semantic-draw/data/data_yolo5_crnn.csv', 'r') as file:
...
# plt.xlabel('Time')
plt.ylabel('End to End Processing Time (seconds)', fontsize=18)
# plt.title('Processing Time Comparison')
plt.grid(True)
plt.savefig("e2e_yolo5.pdf", format="pdf", bbox_inches="tight")
